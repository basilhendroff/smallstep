...
iocage exec "${JAIL_NAME}" sysrc step_ca_user="step"
iocage exec "${JAIL_NAME}" sysrc step_ca_group="step"
iocage exec "${JAIL_NAME}" sysrc step_ca_stepdir="/var/db/step_ca"
iocage exec "${JAIL_NAME}" sysrc step_ca_init="YES"
